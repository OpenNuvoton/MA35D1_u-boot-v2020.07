...
static ulong ma35d0_fb_cal_div_pixel_clk(ulong rate,  u32 *DivVal)
{
...
static ulong ma35d0_fb_cal_pixel_clk_rate(ulong PllSrcClk, ulong rate, u32 *u32Reg)
{
	u32 u32M, u32N, u32P;
...
static void ma35d0_disp_register_init(struct ma35d0_lcd_info *disp_info, void __iomem *regs)
{
	u32 data;
...
static int ma35d0_fb_video_probe(struct udevice *dev)
{
	...
	TargetPixelClk = ma35d0_fb_cal_div_pixel_clk(priv->pixclock.rate, dcpdiv_val);
	priv->pixclock.rate = ma35d0_fb_cal_pixel_clk_rate(24000000, TargetPixelClk, u32Reg);
