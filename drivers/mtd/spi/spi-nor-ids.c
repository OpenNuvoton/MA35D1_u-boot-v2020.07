...
const struct flash_info spi_nor_ids[] = {
	...
	{
		INFO("w25q512nw-iq/in", 0xef6020, 0, 64 * 1024, 1024,
			SECT_4K | SPI_NOR_DUAL_READ | SPI_NOR_QUAD_READ |
			SPI_NOR_HAS_LOCK | SPI_NOR_HAS_TB)
	},
	{
		INFO("w25q01nw", 0xef6021, 0, 64 * 1024, 2048,
			SECT_4K | SPI_NOR_DUAL_READ | SPI_NOR_QUAD_READ |
			SPI_NOR_HAS_LOCK | SPI_NOR_HAS_TB)
	},
	{
	...
	{ INFO("W25N01GV", 0xefaa21, 0, 64 * 2048,  1024, SECT_4K | SPI_NOR_DUAL_READ | SPI_NOR_QUAD_READ) },
	{ INFO("W25M02GV", 0xefab21, 0, 64 * 2048,  2048, SECT_4K | SPI_NOR_DUAL_READ | SPI_NOR_QUAD_READ) },
#endif
#ifdef CONFIG_SPI_NAND_MACRONIX		/* MACRONIX SPI NAND */
	{ INFO("MX35LF1GE4AB", 0xc212, 0, 64 * 2048,  1024, SECT_4K | SPI_NOR_DUAL_READ | SPI_NOR_QUAD_READ) },
	{ INFO("MX35LF2GE4AB", 0xc222, 0, 64 * 2048,  2048, SECT_4K | SPI_NOR_DUAL_READ | SPI_NOR_QUAD_READ) },
#endif
	{ },
};
